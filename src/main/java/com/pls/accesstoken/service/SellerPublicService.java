...
public class SellerPublicService {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(SellerPublicService.class);
    ...
    public List<SellerPublicNumber> getAllList(){
        ...
        if (hasKey) {
            ...
            LOGGER.info("AccessTokenService.getAccessTokenByAppId() : 从redis缓存中获取了accesstoken >> " + sellerPublicNumberList.toString());
